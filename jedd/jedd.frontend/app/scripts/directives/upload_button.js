...
/**
 * @ngdoc directive
 * @name jedd.directive:uploadButton
 * @description
 * # uploadButton
 */
angular.module('jedd')
  .directive('uploadButton', ['file', function (file) {
    return {
      templateUrl: 'views/index/upload_button.html',
      restrict: 'E',
      link: function postLink(scope, element, attrs) {
        var upload_access_code;
        ...
        function initializeDropZone () {
          ...
          dropzone.on('sending', function (file, xhr, formData) {
            ...
            formData.append('upload_access_code', upload_access_code);
          ...
          dropzone.on('addedfile', function (file) {
            ...
            file.create('konstruilo', scope.current_directories.slice(-1).id, file).then(function (result) {
              console.log(result);
              upload_access_code = result.upload_access_code;
